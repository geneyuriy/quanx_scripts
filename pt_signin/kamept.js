const chavy = init()
const cookieName = 'KAMEPT'
const KEY_homeurl = 'chavy_home_url_kamept'
const KEY_homeheader = 'chavy_home_header_kamept'
...
function signin() {
  return new Promise((resolve, reject) => {
    const url = { url: `https://kamept.com/attendance.php`, headers: JSON.parse(VAL_homeheader) }
    ...
    url.headers['Origin'] = 'https://kamept.com'
    url.headers['Accept-Encoding'] = 'gzip, deflate, br'
    url.headers['Content-Type'] = 'application/x-www-form-urlencoded'
    url.headers['Host'] = 'kamept.com'
