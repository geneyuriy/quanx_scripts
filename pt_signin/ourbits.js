...
const KEY_homeurl = 'chavy_home_url_ourbits'
const KEY_homeheader = 'chavy_home_header_ourbits'
...
function signin() {
  return new Promise((resolve, reject) => {
    const url = { url: `https://ourbits.club/attendance.php`, headers: JSON.parse(VAL_homeheader) }
    ...
    url.headers['Origin'] = 'https://ourbits.club'
    url.headers['Accept-Encoding'] = 'gzip, deflate, br'
    url.headers['Content-Type'] = 'application/x-www-form-urlencoded'
    url.headers['Host'] = 'ourbits.club'
